class Networks::CheckDns
  ...
  expects :http_route, :connection

  executed do |context|
    expected_dns = Dns::Utils.infer_expected_hostname(context.http_route, context.connection)
    context.http_route.service.domains.each do |domain|
